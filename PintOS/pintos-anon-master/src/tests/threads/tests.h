...
extern test_func mine_palloc_test;
extern test_func mine_bitmap_gap_test;
extern test_func mine_bestfit_test;
extern test_func mine_print_ready_list_test;
extern test_func mine_next_thread_priority_test;
extern test_func mine_priority_shift_test;
