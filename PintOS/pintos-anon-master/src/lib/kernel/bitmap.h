...
#ifdef BESTFIT
bool bitmap_contains_for_how_long (const struct bitmap *, size_t start, size_t cnt, bool, size_t *);
#endif
...
#ifdef BESTFIT
size_t bitmap_scan_best_fit (const struct bitmap *, size_t start, size_t cnt, bool);
#endif
